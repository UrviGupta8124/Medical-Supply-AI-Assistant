...
llm_primary = ChatGroq(model="openai/gpt-oss-20b", temperature=0, max_tokens=2500)
llm_fallback = ChatGroq(model="openai/gpt-oss-120b", temperature=0, max_tokens=2500)
